...
def data_requisites(json_f):
    ...
    for founder_ul in json_f['data']['Учред']['РосОрг']: # Учредитель ЮЛ
        ...
        founders_list_text_2.append(f'- {name_founder}, ИНН {inn_founder} - '
    ...
    for founder_foreigner in json_f['data']['Учред']['ИнОрг']: # Учредитель нерезидент
        ...
        founders_list_text_2.append(f'- {name_founder}, рег.№ {grn_founder}, '
    ...
    employer_dict =  {'full_name': full_name,
                      ...
                      'inn': inn,
                      'ogrn': ogrn,
                      'General_manager': f'{fio_sole_executive_body}, '
                                         f'ИНН: {inn_sole_executive_body}',
                      'Founders': "\n".join(founders_list_text_2),
                      'date_of_registration': date_reg.date().strftime('%d.%m.%Y'),
